...
class ScoreListTest(unittest.TestCase):
    ...
    def test_a_scenario_for_teacher(self):
        ...
        self.assertEqual(int(Consts.BASE_PRICE['teacher'] - (19 - Consts.MIN_AGE) * Consts.AGE_MUL),
                         teacher.get_price(), '\nتابع get_price از کلاس Teacher را به درستی پیاده‌سازی نکرده‌اید.')

        self.assertEqual(int(Consts.BASE_COST['teacher'] + (19 - Consts.MIN_AGE) * Consts.AGE_MUL),
                         teacher.calc_life_cost(),
        ...
        self.assertEqual(int(Consts.BASE_INCOME['teacher']['mine'] - (19 - Consts.MIN_AGE) * Consts.AGE_MUL),
    ...
    def test_a_scenario_for_engineer(self):
        ...
        self.assertEqual(int(Consts.BASE_INCOME['engineer']['mine'] * math.sqrt(Consts.MIN_AGE / 37)),
                         engineer.calc_income(),
